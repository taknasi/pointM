<!--begin::Header-->
<div id="kt_header" style="box-shadow: 0px 10px 30px 0px rgb(82 63 105 / 5%)" class="header align-items-stretch">
    <!--begin::Container-->
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    ...
                    <a href=""
                        ...
                        <!--end::Svg Icon-->
                        {{-- @if (App\Models\DossierCorporel::onlyTrashed()->count() > 0 || App\Models\Facture::onlyTrashed()->count() > 0) --}}
                            <span
